...
describe('Given the UiModal component', () => {
  describe('when the component is rendered', () => {
    ...
    beforeEach(async () => {
      component = await mountSuspended(UiModal, { route: '/' });
    });

    it('mounts the UiModal component', async () => {
  ...
  describe('when the component is rendered with a slot', () => {
    let component: Awaited<ReturnType<typeof mountSuspended>>;

    beforeEach(async () => {
      component = await mountSuspended(UiModal, {
        route: '/',
