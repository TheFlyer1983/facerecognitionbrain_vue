  ...
  <div class="flex flex-col">
    ...
    <div class="mx-auto">
      ...
      >
        ...
        <button
          @click="submitURL"
          class="cursor-pointer w-[30%] bg-[#A463F2] p-2 text-xl text-white no-underline transition-colors duration-[0.15s] ease-in hover:scale-105 hover:transform hover:duration-[0.25s] hover:ease-out"
          data-test="submit"
        >
          Detect
        </button>
